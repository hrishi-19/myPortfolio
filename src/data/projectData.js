...
export const projects=[
    {
        ...
        content:"Covid-19 Bed allocation System aims at easing the process of bed allocation for covid patients. Patients can register themselves on the website by providing the necessary details asked.",
        imgUrl:"https://i.ibb.co/SVbSgJd/main.png",
        github:"https://github.com/hrishi-19/covid-bed",
        live:null
    },
    {
        title:" Mitra",
        content:"A student utility app which provides various functions helping students. Students can check their results, set up pomodoro sessions, upload assignments and take up notes. Uses google auth for user signin and firebase firesrore for data storage.",
        imgUrl:mitra1,
